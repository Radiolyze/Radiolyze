...
ORTHANC_SEED_URLS="${ORTHANC_SEED_URLS:-https://github.com/pydicom/pydicom-data/raw/master/data_store/data/emri_small.dcm,https://github.com/pydicom/pydicom-data/raw/master/data_store/data/liver.dcm,https://github.com/pydicom/pydicom-data/raw/master/data_store/data/SC_rgb.dcm}"
