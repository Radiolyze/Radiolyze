...
5. Split the backend monoliths (#293) — `inference_clients.py` (774) and `api/training.py` (752) are done, the latter now `app/services/training_export/` behind a routes-only module; `tasks.py` (975) and `api/inference.py` (615) remain.
