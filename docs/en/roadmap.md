...
5. Split the backend monoliths (#293) — `inference_clients.py` (774 lines) is done, now a package of one module per generation flow; `tasks.py` (975) and `api/training.py` (752) remain.
