...
5. Split the backend monoliths — `inference_clients.py` (774 lines) is now the package `inference_clients/`, one module per job family; `tasks.py` (975) and `api/training.py` (752) remain.
