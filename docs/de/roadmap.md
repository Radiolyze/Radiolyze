...
5. Backend-Monolithen aufteilen (#293) — `inference_clients.py` (774) ist erledigt und jetzt ein Paket mit einem Modul je Task-Familie; `tasks.py` (975) und `api/training.py` (752) stehen noch aus.
