...
5. Backend-Monolithen aufteilen — `inference_clients.py` (774 Zeilen) ist jetzt das Paket `inference_clients/` mit einem Modul je Job-Familie; `tasks.py` (975) und `api/training.py` (752) stehen noch aus.
