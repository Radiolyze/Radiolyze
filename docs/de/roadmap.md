...
5. Backend-Monolithen aufteilen (`tasks.py` 975 Zeilen, `api/training.py` 752). `inference_clients.py` ist erledigt — jetzt ein Paket mit einem Modul je Job-Familie.
