...
4. **AI Draft**: MedGemma erzeugt Impression mit Bild-Inputs (current + prior Serien, optional).
...
- Image URLs / lokale Bildpfade fuer Multimodal Inference (gerenderte PNG Frames)
- Image Refs (Study/Series/Frame Metadaten, role=current|prior)
- Evidence Indices (Rueckverweis auf Image Manifest)
