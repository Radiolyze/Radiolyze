...
export const mockReports: Report[] = [
  ...
  },
  {
    ...
    status: "approved",
    findingsText:
      "Herzgröße und -konfiguration normal. Keine Stauungszeichen. Keine Infiltrate. Keine Pleuraergüsse.",
...
export const mockQAChecks = [
  ...
  {
    id: "qa4",
    name: "Größenangabe bei Läsionen",
    status: "warn" as const,
    message: "Empfehlung: Größe in 3 Dimensionen angeben",
  },
  { id: "qa5", name: "Vergleich mit Voruntersuchung", status: "pass" as const },
  {
    ...
    status: "warn" as const,
    message: "Bei Lungenrundherd >8mm: Follow-up Empfehlung prüfen",
  },
];
