...
export async function updateAnnotation(
  ...
  return apiClient.patch<TrainingAnnotation>(`${BASE_PATH}/${annotationId}`, payload);
}
...
export async function verifyAnnotation(
  ...
  return apiClient.post<TrainingAnnotation>(`${BASE_PATH}/${annotationId}/verify`, payload);
}
...
export async function countAnnotations(params: AnnotationListParams = {}): Promise<number> {
