      ...
      <main className="max-w-3xl mx-auto p-6 space-y-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              {t("display.themeOptions.dark")}, {t("display.themeOptions.light")},{" "}
              {t("display.language")}
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                ...
                <p className="text-xs text-muted-foreground">UI-Sprache / UI language</p>
              </div>
              <Select
            ...
            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                ...
                <p className="text-xs text-muted-foreground">
                  {t("display.fontSizeOptions.small")} / {t("display.fontSizeOptions.medium")} /{" "}
                  {t("display.fontSizeOptions.large")}
                </p>
              </div>
              <Select
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>{t("audio.microphoneDescription")}</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                <Label>{t("audio.microphone")}</Label>
                <p className="text-xs text-muted-foreground">{t("audio.microphoneDescription")}</p>
              </div>
              <Switch
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>{t("viewer.defaultTool")}</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                ...
                <p className="text-xs text-muted-foreground">
                  {t("viewer.toolOptions.window")} / {t("viewer.toolOptions.zoom")} /{" "}
                  {t("viewer.toolOptions.pan")}
                </p>
              </div>
              <Select
                value={preferences.defaultTool}
                onValueChange={(v) =>
                  setPreference("defaultTool", v as "zoom" | "pan" | "measure" | "window")
                }
              >
                <SelectTrigger className="w-32">
                  <SelectValue />
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>{t("report.autoGenerateImpressionDescription")}</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
