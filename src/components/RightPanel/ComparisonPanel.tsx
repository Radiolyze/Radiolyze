...
export type ComparisonStatus = "new" | "progressed" | "stable" | "regressed" | "resolved";
...
export function ComparisonPanel({
  ...
  const sortedChanges = useMemo(() => {
    ...
    const order: ComparisonStatus[] = ["progressed", "new", "regressed", "stable", "resolved"];
    return [...result.changes].sort((a, b) => order.indexOf(a.status) - order.indexOf(b.status));
  }, [result?.changes]);
