  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Verbindung zum PACS/DICOMweb-Server konfigurieren</CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            Vollständige URL zum DICOMweb-Endpunkt (WADO-RS/STOW-RS/QIDO-RS). Im Docker/SSH-Setup
            funktioniert meist <span className="font-mono">/dicom-web</span> über den
            Frontend-Proxy.
          </p>
        </div>
        ...
        {hasUnsavedChanges && (
          <p className="text-xs text-warning">
            Ungespeicherte Änderungen. Klicken Sie auf &quot;Speichern&quot;, um die Konfiguration
            zu übernehmen.
          </p>
        )}
      </CardContent>
