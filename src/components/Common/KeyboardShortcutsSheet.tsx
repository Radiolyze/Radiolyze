...
export function KeyboardShortcutsSheet({ open, onOpenChange }: KeyboardShortcutsSheetProps) {
  ...
  const generalShortcuts: ShortcutGroup[] = [
    {
      ...
      shortcuts: [
        ...
        {
          keys: ["Ctrl", "Enter"],
          descriptionKey: "shortcuts.actions.approveReport",
          icon: CheckCircle,
        },
  ...
  const mprShortcuts: ShortcutGroup[] = [
    ...
    },
    {
      ...
      shortcuts: [{ keys: ["M"], descriptionKey: "shortcuts.actions.toggleMIP", icon: Layers }],
    },
    {
        ...
        {group.shortcuts.map((shortcut) => (
          ...
          >
            <div className="flex items-center gap-2 text-sm">
              {shortcut.icon && <shortcut.icon className="h-3.5 w-3.5 text-muted-foreground" />}
      ...
      <SheetContent className="w-[480px] sm:max-w-[480px] p-0 flex flex-col">
          ...
          <ScrollArea className="flex-1 px-6 py-4">
            ...
            <TabsContent value="mpr" className="mt-0 space-y-4">
              <div className="p-2 rounded-md bg-primary/10 border border-primary/20 mb-4">
                <p className="text-xs text-primary">{t("shortcuts.hints.mprAvailable")}</p>
              </div>
            ...
            <TabsContent value="vrt" className="mt-0 space-y-4">
              <div className="p-2 rounded-md bg-primary/10 border border-primary/20 mb-4">
                <p className="text-xs text-primary">{t("shortcuts.hints.vrtAvailable")}</p>
              </div>
        ...
        <div className="px-6 py-4 border-t border-border bg-muted/30">
          <p className="text-xs text-muted-foreground text-center">
            ...
            <Badge variant="outline" className="font-mono text-[10px] px-1.5 mx-1 bg-background">
              ?
            </Badge>
