"""Findings-summary generation -- the narrative summary of a study's findings.

Same shape as ``impression``, different prompt and output schema; the two are
kept apart because their prompts and mock fallbacks evolve independently.
"""
