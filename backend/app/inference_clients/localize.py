"""Single-frame localization -- bounding boxes for findings or anatomy on a CXR.

Unlike the other task families this one is modality-gated: the prompts and the
0-1000 box convention are validated for chest radiographs only, so a request for
any other modality is refused rather than answered with an untrustworthy box.
"""
