...
Unlike the other families this one is modality-gated: both prompts are
validated for CXR only, so a request against another modality is rejected up
front with :class:`UnsupportedModalityError` rather than answered with a
