"""Impression generation -- the short conclusion drawn from a report's findings.

The blocking call and the SSE-streamed variant both live here because they share
the prompt builder; separating them would only move the coupling elsewhere.
"""
